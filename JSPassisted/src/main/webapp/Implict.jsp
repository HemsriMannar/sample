...
<%
        ...
        if (responseCheck != null ) {
                 ...
                 response.setHeader("Location", "reponseridirect.jsp?office=" + responseCheck);
        }
...
%>
<a href="Implict.jsp?office=head_office">Show usage of response object</a><br>
<a href="Implict.jsp?error=1">Show usage of error  object</a><br>
